...
let buttonsProd = document.querySelectorAll('button');
buttonsProd.forEach(function (button) {
...
function showCategory(category) {
    switch (category) {
        case "phones":
            productsEl.insertAdjacentHTML('afterbegin', `${getProductMarkup(products.phones)}`);
            break;
        case "tablets":
            productsEl.insertAdjacentHTML('afterbegin', `${getProductMarkup(products.tablets)}`);
            break;
        case "tv":
            productsEl.insertAdjacentHTML('afterbegin', `${getProductMarkup(products.tv)}`);
            break;
    }
}
...
function getProductMarkup(product) {
    ...
    product.forEach(function (item) {
        markup = ` ${markup} <div class="product">
    <div>${item.name}</div>
